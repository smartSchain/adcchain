...
[Build Status](https://github.com/smartSchain/adcchain/branches):

`master` | `develop`  
 --- | --- | --- | --- | ---
 [![](https://github.com/smartSchain/adcchain/master)](https://github.com/smartSchain/adcchain) | [![](https://github.com/smartSchain/adcchain/tree/develop)](https://github.com/smartSchain/adcchain) 
...
[wiki](https://github.com/smartSchain/adcchain/wiki).
...
To build after all dependencies are installed:
    ...
    git clone https://github.com/smartSchain/adcchain.git
    cd adcchain
...
**NOTE:** ADCChain requires an [OpenSSL](https://www.openssl.org/) version in the 1.0.x series. OpenSSL 1.1.0 and newer are NOT supported. If your system OpenSSL version is newer, then you will need to manually provide an older version of OpenSSL and specify it to CMake using `-DOPENSSL_INCLUDE_DIR`, `-DOPENSSL_SSL_LIBRARY`, and `-DOPENSSL_CRYPTO_LIBRARY`.

**NOTE:** ADCChain requires a [Boost](http://www.boost.org/) version in the range [1.57, 1.63]. Versions earlier than
...
**NOTE:** By default the witness node will start in reduced memory ram mode by using some of the commands detailed in [Memory reduction for nodes](https://github.com/smartSchain/adcchain/wiki/Memory-reduction-for-nodes).
...
[here](https://github.com/smartSchain/adcchain/blob/master/libraries/wallet/include/graphene/wallet/wallet.hpp).

Support
-------

ADCChain Core bugs can be reported directly to the [issue tracker](https://github.com/smartSchain/adcchain/issues).

ADCChain UI bugs should be reported to the [UI issue tracker](https://github.com/smartSchain/adc-ui/issues)

Up to date online Doxygen documentation can be found at [Doxygen](https://adc.org/doxygen/hierarchy.html)
...
about API's for the [witness node](https://adc.github.io/doxygen/namespacegraphene_1_1app.html) and the
[wallet](https://adc.github.io/doxygen/classgraphene_1_1wallet_1_1wallet__api.html).
If you want information which is not available from an API, it might be available
from the [database](https://adc.github.io/doxygen/classgraphene_1_1chain_1_1database.html);
...
- What is the meaning of `a.b.c` numbers?
    ...
    [types.hpp](https://github.com/smartSchain/adc-2/blob/smartSchain/libraries/chain/include/graphene/chain/protocol/types.hpp).
...
License
-------
ADCChain Core is under the MIT license. See [LICENSE](https://github.com/smartSchain/adcchain/blob/master/LICENSE.txt)
